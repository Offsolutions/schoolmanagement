...
namespace SchoolFee.Controllers
{
    public class RegistrationsController : BaseController
    {
        ...
        public static DateTime dtadd;
        // GET: Registrations
        public async Task<ActionResult> Index()
        {
            var registrations = db.Registrations.OrderByDescending(x => x.REGId).Include(r => r.CatDatas).Include(r => r.SchoolClasses).Include(r => r.Sections).Include(r => r.TransportCharges);
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            dtdob = registration.DOB;
            dtadd = registration.AdmissionDate;
            if (registration == null)
            {
                return HttpNotFound();
            }
